...
//        m_animationtype = QEasingCurve::OutBack;  //check out the QEasingCurve documentation for different styles
        m_animationtype = QEasingCurve::OutQuad;  //check out the QEasingCurve documentation for different styles
        m_now=0;
        m_next=0;
        m_wrap=false;
        m_pnow=QPoint(0,0);
...
int SlidingStackedWidget::speed()
{
    return m_speed;
}
